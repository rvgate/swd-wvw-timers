...
function populateScoreboard() {
    ...
    $('.server_red .score').each(function(){ this.innerHTML = match_details.scores[score_mapping['red']]});
    $('.server_blue .score').each(function(){ this.innerHTML = match_details.scores[score_mapping['blue']]});
    $('.server_green .score').each(function(){ this.innerHTML = match_details.scores[score_mapping['green']]});
